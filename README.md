...
**1. Top-1/5 accuracy of pre-train models in this repository.**
 ...
 resnet38a1| 78.90/94.55 | ../.. | 80.31/95.26 | ../..
...
**4. Top-1/5 accuracy of some lightweight or low-accuracy networks from the open source.**
 ...
 - crop_size=224 and base_size=224 for inception_v1(dsd), and it will achieve 69.27/89.38 by crop_size=224 and base_size=256x256.
 - vgg16_dsd will achieve 72.38/90.98 by crop_size=224 and base_size=256x256.
