...
def residual_branch(bottom, base_output=64):
    ...
    branch2c, branch2c_bn, branch2c_scale, branch2c_relu = \
        factorization_conv_bn_scale_relu(branch2b, num_output=4 * base_output, kernel_size=1)  # 4*base_output x n x n
    ...
    return branch2a, branch2a_bn, branch2a_scale, branch2a_relu, branch2b, branch2b_bn, branch2b_scale, branch2b_relu, \
           branch2c, branch2c_bn, branch2c_scale, branch2c_relu, residual, residual_relu
...
def residual_branch_shortcut(bottom, stride=2, base_output=64):
    ...
    :return: layers
    """
    branch1, branch1_bn, branch1_scale, branch1_relu = \
        factorization_conv_bn_scale_relu(bottom, num_output=4 * base_output, kernel_size=1, stride=stride)
    ...
    branch2c, branch2c_bn, branch2c_scale, branch2c_relu = \
        factorization_conv_bn_scale_relu(branch2b, num_output=4 * base_output, kernel_size=1)

    residual, residual_relu = \
        eltwize_relu(branch1, branch2c)  # 4*base_output x n x n

    return branch1, branch1_bn, branch1_scale, branch1_relu, branch2a, branch2a_bn, branch2a_scale, branch2a_relu, \
           branch2b, branch2b_bn, branch2b_scale, branch2b_relu, branch2c, branch2c_bn, branch2c_scale, branch2c_relu, \
           residual, residual_relu


branch_shortcut_string = 'n.res(stage)a_branch1, n.res(stage)a_branch1_bn, n.res(stage)a_branch1_scale, n.res(stage)a_branch1_relu, \
        ...
        n.res(stage)a_branch2c, n.res(stage)a_branch2c_bn, n.res(stage)a_branch2c_scale, n.res(stage)a_branch2c_relu, \
        n.res(stage)a, n.res(stage)a_relu = \
...
branch_string = 'n.res(stage)b(order)_branch2a, n.res(stage)b(order)_branch2a_bn, n.res(stage)b(order)_branch2a_scale, \
        ...
        n.res(stage)b(order)_branch2c_bn, n.res(stage)b(order)_branch2c_scale, n.res(stage)b(order)_branch2c_relu, \
